 ...
 *
 * Original file: tests/node/unit-tests/test-data-methods.js
...
var LpPacket = require('../../../js/lp/lp-packet.js').LpPacket;
...
var CONGESTION_MARK_PACKET = new Buffer([
...
describe('TestDataMethods', function() {
  ...
  it('CongestionMark', function() {
    ...
    var element = lpPacket.getFragmentWireEncoding().buf();

    var data = new Data();
    data.wireDecode(element, TlvWireFormat.get());
    data.setLpPacket(lpPacket);

    assert.equal(1, data.getCongestionMark());
  });
});
