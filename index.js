...
exports.RegistrationOptions = require('./js/registration-options.js').RegistrationOptions;
...
exports.DataFetcher = require('./js/util/data-fetcher.js').DataFetcher;
exports.PipelineFixed = require('./js/util/pipeline-fixed.js').PipelineFixed;
exports.SegmentFetcher = require('./js/util/segment-fetcher.js').SegmentFetcher;
exports.SyncPromise = require('./js/util/sync-promise.js').SyncPromise;
...
exports.TpmKeyHandle = require('./js/security/tpm/tpm-key-handle.js').TpmKeyHandle;
exports.TpmPrivateKey = require('./js/security/tpm/tpm-private-key.js').TpmPrivateKey;
...
exports.X509CrlCache = require('./js/security/v2/x509-crl-cache.js').X509CrlCache;
exports.X509CrlFetcher = require('./js/security/v2/x509-crl-fetcher.js').X509CrlFetcher;
